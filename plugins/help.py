...
################# 主函数 ##################
def fun_help(name_space, function_type, post_type, user_state:list, priority, role=[], block=False):
    def decorator(func):
...
################# 子函数 ##################
# 插件函数示例1
@fun_help(name_space="帮助", function_type="parallel", post_type="message", user_state=["聊天"], priority=1)
def fun_1(data):
